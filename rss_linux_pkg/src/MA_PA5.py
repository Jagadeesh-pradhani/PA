...
if __name__ == '__main__':
    ...
    try:
        print("Moving in circle for 20 sec")
        moveturtlebot_object.move_turtlebot(20,0.2,0.4)
        print("Stopped for 5 sec")
        moveturtlebot_object.move_turtlebot(5,0,0)
        print("Move straight for 5 sec")
        moveturtlebot_object.move_turtlebot(5,0.2,0)
